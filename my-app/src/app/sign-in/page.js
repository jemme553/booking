export default function Page() {
  return (
    <div className="flex justify-center bg-black h-screen">
      <form className="w-[90%] gap-5 flex flex-col mt-10 py-5 " >
        <h1 className="text-secondary text-center text-xl">Login</h1>
        ...
        <input type="submit" className="btn btn-outline btn-secondary" value='Login' />
      </form>
    </div>
  );
}
